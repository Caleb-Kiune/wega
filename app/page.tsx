      ...
      <section className="section-padding-lg" style={{background: 'linear-gradient(135deg, #10b981, #059669, #047857)'}}>
        <div className="container-responsive px-4 sm:px-8">
          ...
          <div className="text-center mt-12">
            <Link
              href="/products"
              className="inline-flex items-center text-responsive-base px-10 py-5 rounded-2xl bg-gradient-to-r from-green-400 to-emerald-500 text-white shadow-lg hover:shadow-xl hover:from-green-500 hover:to-emerald-600 transition-all duration-300"
            >
