        ...
        <div className="container mx-auto max-w-7xl">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 sm:mb-8">
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600">Discover our most popular kitchenware items</p>
            </div>
            <Link
              href="/products?is_featured=true"
              className="inline-flex items-center text-green-600 font-medium mt-4 md:mt-0 hover:text-green-700 p-2 -m-2 rounded-lg min-h-[44px] min-w-[44px]"
            >
              View all products
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 sm:mb-8">
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600">Check out our latest kitchenware additions</p>
            </div>
            <Link
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 sm:mb-8">
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600">Limited time deals on premium kitchenware</p>
            </div>
            <Link
